	...
	<form id="rpress_register_form" class="rpress_form" action="" method="post">
		...
		<div>
			<!-- <legend><?php esc_html_e( 'Register New User', 'restropress' ); ?></legend> -->
			 <h1 class="rpress-login-hd"><?php esc_html_e( 'Create an Account', 'restropress' ); ?></h1>
			  <div class="welcome-text-wrap"><?php esc_html_e( 'Welcome! Let’s set things up', 'restropress' ); ?>
			</div>
			<?php
			...
			if( ! is_user_logged_in() && $login_method != 'guest_only' ){
				...
				<div class="hr-lines"><?php esc_html_e( 'or Register with', 'restropress' ); ?></div>
				<?php
			}	
			?>
			...
			<p>
				...
				<input id="rpress-user-login" class="required rpress-input" type="text" name="rpress_user_login" placeholder="<?php esc_attr_e( 'Enter your name', 'restropress' ); ?>" />
			</p>
			<p>
				<label for="rpress-user-email"><?php esc_html_e( 'Email', 'restropress' ); ?></label>
				<input id="rpress-user-email" class="required rpress-input" type="email" name="rpress_user_email" placeholder="<?php esc_attr_e( 'E.g. johndoe@email.com', 'restropress' ); ?>" />
			</p>
			<p>
				<label for="rpress-user-pass"><?php esc_html_e( 'Password', 'restropress' ); ?></label>
				<input id="rpress-user-pass" class="password required rpress-input" type="password" name="rpress_user_pass" placeholder="<?php esc_attr_e( 'Enter your password', 'restropress' ); ?>" />
			</p>
			<p>
				<label for="rpress-user-pass2"><?php esc_html_e( 'Confirm Password', 'restropress' ); ?></label>
				<input id="rpress-user-pass2" class="password required rpress-input" type="password" name="rpress_user_pass2" placeholder="<?php esc_attr_e( 'Enter confirm password', 'restropress' ); ?>" />
			</p>
			...
			<p class="register-link-wrap"><?php esc_html_e( 'Already have an account?', 'restropress' ); ?> <a href="<?php echo esc_url( site_url('/login') ); ?>" class="reglink"><?php esc_html_e( 'Sign In', 'restropress' ); ?>
