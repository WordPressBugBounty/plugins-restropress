...
<li class="cart_item rpress-cart-meta rpress_cart_tax" style="display:none;"><?php esc_html_e( 'Estimated Tax:', 'restropress' ); ?> <span class="cart-tax"><?php echo esc_html( rpress_currency_filter( rpress_format_amount( rpress_get_cart_tax() ) ) ); ?></span></li>
<?php endif; ?>
