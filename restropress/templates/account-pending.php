...
<p class="rpress-account-pending">
    ...
    echo wp_kses(
        sprintf(
            /* translators: %s is the link to resend activation */
            __( 'Your account is pending verification. Please click the link in your email to activate your account. No email? <a href="%s">Click here</a> to send a new activation code.', 'restropress' ),
            $url
        ),
        array(
            'a' => array(
