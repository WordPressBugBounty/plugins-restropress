			...
			array(
				...
				'accounting' => array(
					...
					'enable_sequential' => array(
						...
						'desc' => esc_html__('Enter your preferred starting number for the sequence (e.g., 100, 1000, etc.). ', 'restropress'),
						'type' => 'text',
					),
		...
		<div class="rpress_email_field_settings_wrapper">
			<h2><?php echo esc_html($status); ?>
				<small class="rpress-admin-breadcrumb">
					<a
						href="<?php echo esc_url(admin_url('admin.php?page=rpress-settings&tab=emails&section=order_notifications')); ?>">⤴</a>
				</small>
			</h2>
			<table>
				<tr>
					...
					<td>
						<label for="enable_disable">
							<input id="enable_disable" <?php echo esc_attr($enable_notification); ?> value="yes"
								type="checkbox"
								name="<?php echo esc_attr('rpress_settings[' . $order_status . '][enable_notification]'); ?>">
					...
					<tr>
						...
						<td>
							<textarea class="large-text" rows="5" cols="50" id="admin_recipients"
								name="<?php echo esc_attr('rpress_settings[' . $order_status . '][admin_recipients]'); ?>"><?php echo esc_html($email_recipients); ?></textarea>
							<span
								class="help-text"><?php esc_html_e('Enter the email address(es) that should receive a notification anytime a order is placed, one per line.', 'restropress'); ?></span>
						</td>
					</tr>
				<?php endif; ?>
				<tr>
					...
					<td>
						<input id="subject" type="text"
							name="<?php echo esc_attr('rpress_settings[' . $order_status . '][subject]'); ?>"
				...
				<tr>
					...
					<td>
						<input id="email_heading" type="text"
							name="<?php echo esc_attr('rpress_settings[' . $order_status . '][heading]'); ?>"
							value="<?php echo esc_attr($email_heading); ?>">
					</td>
				</tr>
				<tr>
