...
function rpress_tools_banned_emails_display()
{
	...
	<div class="postbox">
		...
		<div class="inside">
			<p><?php esc_html_e('Emails placed in the box below will not be allowed to make purchases.', 'restropress'); ?>
			</p>
			<form method="post" action="<?php echo esc_url(admin_url('admin.php?page=rpress-tools&tab=general')); ?>">
				<p>
				...
				<span>
					...
					<select name="rpress-export-class" id="recount-stats-type">
						...
						<option data-type="recount-store" value="RPRESS_Tools_Recount_Store_Earnings">
							<?php esc_html_e('Recount Store Earnings and Sales', 'restropress'); ?></option>
						<option data-type="recount-fooditem" value="RPRESS_Tools_Recount_Download_Stats">
							<?php printf(esc_html__('Recount Earnings and Sales for a %s', 'restropress'), esc_html(rpress_get_label_singular(true))); ?>
						</option>
						<option data-type="recount-all" value="RPRESS_Tools_Recount_All_Stats">
							<?php printf(esc_html__('Recount Earnings and Sales for All %s', 'restropress'), esc_html(rpress_get_label_plural(true))); ?>
						</option>
						<option data-type="recount-customer-stats" value="RPRESS_Tools_Recount_Customer_Stats">
							<?php esc_html_e('Recount Customer Stats', 'restropress'); ?></option>
						<?php do_action('rpress_recount_tool_options'); ?>
						<option data-type="reset-stats" value="RPRESS_Tools_Reset_Stats">
							<?php esc_html_e('Reset Store', 'restropress'); ?></option>
					</select>
					...
					<span class="rpress-recount-stats-descriptions">
						<span
							id="recount-store"><?php esc_html_e('Recalculates the total store earnings and sales.', 'restropress'); ?></span>
						<span
							id="recount-fooditem"><?php printf(esc_html__('Recalculates the earnings and sales stats for a specific %s.', 'restropress'), esc_html(rpress_get_label_singular(true))); ?></span>
						<span
							id="recount-all"><?php printf(esc_html__('Recalculates the earnings and sales stats for all %s.', 'restropress'), esc_html(rpress_get_label_plural(true))); ?></span>
						<span
							id="recount-customer-stats"><?php esc_html_e('Recalculates the lifetime value and purchase counts for all customers.', 'restropress'); ?></span>
						<?php do_action('rpress_recount_tool_descriptions'); ?>
						<span
							id="reset-stats"><?php esc_html_e('<strong>Deletes</strong> all payment records, customers, and related log entries.', 'restropress'); ?></span>
					</span>
...
function rpress_tools_import_export_display()
{
	...
	<div class="postbox rpress-import-fooditems">
		...
		<div class="inside">
			...
			<form id="rpress-import-fooditems" class="rpress-import-form rpress-import-export-form"
				...
				<div class="rpress-import-file-wrap">
					...
					<span>
						<input type="submit" value="<?php esc_html_e('Import CSV', 'restropress'); ?>"
							class="button-secondary" />
						<span class="spinner"></span>
					</span>
				</div>
				<div class="rpress-import-options" id="rpress-import-fooditems-options" style="display:none;">
					<p>
						...
						printf(
							esc_html(
								esc_html__('Each column loaded from the CSV needs to be mapped to a Food Item field. Select the column that should be mapped to each field below. Any columns not needed can be ignored.', 'restropress')
							)
						);
						?>
					</p>
					<table class="widefat rpress_repeatable_table striped" width="100%" cellpadding="0" cellspacing="0">
						...
						<tbody>
							<tr>
								...
								<td>
									<select name="rpress-import-field[post_author]" class="rpress-import-csv-column"
										data-field="Author">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
								</td>
								<td class="rpress-import-preview-field">
									<?php esc_html_e('- select field to preview data -', 'restropress'); ?></td>
							</tr>
							<tr>
								<td><?php esc_html_e('Product Categories', 'restropress'); ?></td>
								<td>
									<select name="rpress-import-field[categories]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[addons]" class="rpress-import-csv-column"
										data-field="Addons">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[addon_prices]" class="rpress-import-csv-column"
										data-field="Addon Prices">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
								</td>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[addon_is_required]" class="rpress-import-csv-column"
										data-field="Addons Is Required">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
								</td>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[addon_max]" class="rpress-import-csv-column"
										data-field="Max Addons">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
								</td>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[variable_price_label]"
										class="rpress-import-csv-column" data-field="Variable Price Label">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
								</td>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[default_addons]" class="rpress-import-csv-column"
										data-field="Default Addons">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
								</td>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[post_date]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[post_content]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[post_excerpt]" class="rpress-import-csv-column"
										data-field="Excerpt">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[featured_image]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[notes]" class="rpress-import-csv-column"
										data-field="Notes">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[price]" class="rpress-import-csv-column"
										data-field="Price">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[sku]" class="rpress-import-csv-column"
										data-field="SKU">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[post_name]" class="rpress-import-csv-column"
										data-field="Slug">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[post_status]" class="rpress-import-csv-column"
										data-field="Status">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[tags]" class="rpress-import-csv-column"
										data-field="Tags">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[tag_mark]" class="rpress-import-csv-column"
										data-field="None/Veg/Non-Veg">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
								</td>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[post_title]" class="rpress-import-csv-column"
										data-field="Name">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[sales]" class="rpress-import-csv-column"
										data-field="Sales">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[earnings]" class="rpress-import-csv-column"
										data-field="Earnings">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
					...
					<p class="submit">
						<button
							class="rpress-import-proceed button-primary"><?php esc_html_e('Process Import', 'restropress'); ?></button>
					</p>
				</div>
			</form>
		</div><!-- .inside -->
	...
	<div class="postbox rpress-import-payment-history">
		...
		<div class="inside">
			...
			<form id="rpress-import-payments" class="rpress-import-form rpress-import-export-form"
				action="<?php echo esc_url(add_query_arg('rpress_action', 'upload_import_file', admin_url())); ?>"
				method="post" enctype="multipart/form-data">
				<div class="rpress-import-file-wrap">
					<?php wp_nonce_field('rpress_ajax_import', 'rpress_ajax_import'); ?>
				...
				<div class="rpress-import-options" id="rpress-import-payments-options" style="display:none;">
					<p>
						...
						printf(
							esc_html(
								esc_html__('Each column loaded from the CSV needs to be mapped to a order field. Select the column that should be mapped to each field below. Any columns not needed can be ignored.', 'restropress')
							)
						);
						?>
					</p>
					<table class="widefat rpress_repeatable_table striped" width="100%" cellpadding="0" cellspacing="0">
						...
						<tbody>
							<tr>
								...
								<td>
									<select name="rpress-import-field[currency]" class="rpress-import-csv-column"
										data-field="Currency">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[email]" class="rpress-import-csv-column"
										data-field="Email">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[first_name]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[last_name]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[customer_id]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[discounts]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[ip]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[mode]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[parent_payment_id]" class="rpress-import-csv-column"
										data-field="">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[gateway]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[number]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[date]" class="rpress-import-csv-column"
										data-field="Date">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[key]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[fooditems]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[status]" class="rpress-import-csv-column"
										data-field="Status">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[subtotal]" class="rpress-import-csv-column"
										data-field="">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[tax]" class="rpress-import-csv-column"
										data-field="Tax ($)">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[total]" class="rpress-import-csv-column"
										data-field="Amount ($)">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[transaction_id]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[user_id]" class="rpress-import-csv-column"
										data-field="User">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[line1]" class="rpress-import-csv-column"
										data-field="Address">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[line2]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[city]" class="rpress-import-csv-column"
										data-field="City">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[state]" class="rpress-import-csv-column"
										data-field="State">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[zip]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[country]" class="rpress-import-csv-column"
										data-field="Country">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
	...
	<div class="postbox rpress-import-customer-history">
		...
		<div class="inside">
			...
			<form id="rpress-import-customers" class="rpress-import-form rpress-import-export-form"
				action="<?php echo esc_url(add_query_arg('rpress_action', 'upload_import_file', admin_url())); ?>"
				method="post" enctype="multipart/form-data">
				<div class="rpress-import-file-wrap">
					<?php wp_nonce_field('rpress_ajax_import', 'rpress_ajax_import'); ?>
				...
				<div class="rpress-import-options" id="rpress-import-customers-options" style="display:none;">
					<p>
						...
						printf(
							esc_html(
								esc_html__('Each column loaded from the CSV needs to be mapped to a customer field. Select the column that should be mapped to each field below. Any columns not needed can be ignored.', 'restropress')
							)
						);
						?>
					</p>
					<table class="widefat rpress_repeatable_table striped" width="100%" cellpadding="0" cellspacing="0">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[user_login]" class="rpress-import-csv-column"
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[user_pass]" class="rpress-import-csv-column"
										data-field="Password">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[payment_ids]" class="rpress-import-csv-column"
										data-field="Payment IDS">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
								</td>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[date_created]" class="rpress-import-csv-column"
										data-field="Date Created">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[name]" class="rpress-import-csv-column"
										data-field="Name">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[purchase_count]" class="rpress-import-csv-column"
										data-field="Number of Purchases">
										<option value=""><?php esc_html_e('- Ignore this field -', 'restropress'); ?>
										</option>
									</select>
								</td>
							...
							<tr>
								...
								<td>
									<select name="rpress-import-field[purchase_value]" class="rpress-import-csv-column"
	...
	<div class="postbox">
		...
		<div class="inside">
			<p><?php esc_html_e('Export the RestroPress settings for this site as a .json file. This allows you to easily import the configuration into another site.', 'restropress'); ?>
			</p>
			<p>
				<?php
				$link = admin_url('admin.php?page=rpress-reports&tab=export');
				$message = sprintf(
			...
			<form method="post"
				action="<?php echo esc_url(admin_url('admin.php?page=rpress-tools&tab=import_export')); ?>">
	...
	<div class="postbox">
		...
		<div class="inside">
			<p><?php esc_html_e('Import the RestroPress settings from a .json file. This file can be obtained by exporting the settings on another site using the form above.', 'restropress'); ?>
			</p>
...
function rpress_tools_import_export_process_import()
{
	...
	wp_safe_redirect(admin_url('admin.php?page=rpress-tools&rpress-message=settings-imported'));
	exit;
}
...
function rpress_tools_sysinfo_display()
{
	...
	?>
	<form action="<?php echo esc_url(admin_url('admin.php?page=rpress-tools&tab=system_info')); ?>" method="post"
		dir="ltr">
