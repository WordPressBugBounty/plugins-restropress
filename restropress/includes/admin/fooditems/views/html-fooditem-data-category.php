					...
					<tbody>
						<tr>
							...
							<td class="rp-select-category">
								<select name="food_categories[]" class="rp-category-select rp-select2"
									multiple="multiple">
								...
								$tip = __('Select the food categories you would like to assign to this food item. This will be used for the filtering on the food items list page.', 'restropress');
								echo wp_kses(rp_help_tip($tip), $allowed_html);
								?>
							</td>
						</tr>
						<tr class="rp-add-category hidden">
							<th scope="row"></th>
							<td>
								<input type="text" class="rp-input" name="rp_category" id="rp-category-name"
									placeholder="<?php esc_html_e('Enter Category Name', 'restropress'); ?>">
